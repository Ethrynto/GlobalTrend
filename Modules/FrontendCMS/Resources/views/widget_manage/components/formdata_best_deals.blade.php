...
<div id="hide_for_top_bar" class="row w-100">
            ...
            @foreach ($LanguageList as $key => $language)
                <li class="nav-item lang_code" data-id="{{$language->code}}">
                    <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                       href="#element{{$language->code}}" role="tab" data-toggle="tab"
                ...
                <div role="tabpanel"
                    ...
                    <div class="primary_input mb-15">
                        ...
                        <input class="primary_input_field" name="title[{{$language->code}}]"
                               id="title{{$language->code}}" placeholder="{{ __('common.title') }}" type="text"
                               value="{{isset($data)?$data->getTranslation('title',$language->code):old('title.'.$language->code)}}">
            ...
            <div class="primary_input mb-25">
                ...
                <select name="product_list[]" id="product_list" class="primary_select mb-15" multiple>
                    @foreach($products as $key => $product)
                        <option @if($data->products->where('seller_product_id',$product->id)->first()) selected
                                @endif value="{{$product->id}}">{{$product->product->product_name}} @if(isModuleActive('MultiVendor'))
            ...
            <div class="primary_input mb-25">
                ...
                <select name="category_list[]" id="category_list" class="primary_select mb-15" multiple>
                    @foreach($categories as $key => $category)
                        <option @if($data->categories->where('category_id',$category->id)->first()) selected
            ...
            <div class="primary_input mb-25">
                ...
                <select name="brand_list[]" id="brand_list" class="primary_select mb-15" multiple>
                    @foreach($brands as $key => $brand)
                        <option @if($data->brands->where('brand_id',$brand->id)->first()) selected
    ...
    @if($data->section_for == 4 && $data->section_name == 'filter_category_1')
        ...
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('frontendCms.section_image') }}
                    ({{getNumberTranslate(330)}} X {{getNumberTranslate(860)}}){{__('common.px')}}</label>
                <div class="primary_file_uploader">
                    <input class="primary-input" type="text" id="filter_category_image_file"
                           placeholder="{{__('common.browse_image_file')}}" readonly="">
                    <button class="" type="button">
                        <label class="primary-btn small fix-gr-bg"
                               for="filter_category_image">{{__("common.browse")}} </label>
                        <input type="file" class="d-none image_file" accept="image/*" name="filter_category_image"
                               id="filter_category_image" data-name_id="#filter_category_image_file"
                               data-view_id="#filter_category_image_show">
                    </button>
                </div>
                ...
                <div class="form_img_div">
                    <img id="filter_category_image_show"
                         src="{{ showImage($data->customSection->field_2?$data->customSection->field_2:'backend/img/default.png') }}"
                         alt="">
                </div>
            </div>
        </div>
    @elseif($data->section_for == 4 && $data->section_name == 'filter_category_2')
        ...
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                ...
                @enderror
                <div class="form_img_div">
                    <img id="filter_category_image_show_2"
                         src="{{ showImage($data->customSection->field_2?$data->customSection->field_2:'backend/img/default.png') }}"
                         alt="">
                </div>
            </div>
    ...
    @elseif($data->section_for == 4 && $data->section_name == 'filter_category_3')
        ...
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('frontendCms.section_image') }}
                    ({{getNumberTranslate(330)}} X {{getNumberTranslate(860)}}){{__('common.px')}}</label>
                <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="false" data-type="image"
                     data-name="filter_category_image">
                    <input class="primary-input file_amount" type="text" id="filter_category_image_file"
                           placeholder="{{__('common.browse_image_file')}}" readonly="">
                    <button class="" type="button">
                        <label class="primary-btn small fix-gr-bg"
                               for="filter_category_image">{{__('common.browse') }} </label>
                ...
                <div class="product_image_all_div">
                    <img id="filter_category_image_show_3"
                         src="{{ showImage($data->customSection->field_2?$data->customSection->field_2:'backend/img/default.png') }}"
                         alt="">
                </div>
            </div>
    ...
    @elseif($data->section_for == 4 && $data->section_name == 'discount_banner')
        ...
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('frontendCms.section_image_1') }}
                    ({{getNumberTranslate(450)}} X {{getNumberTranslate(300)}}){{__('common.px')}}</label>
                <div class="primary_file_uploader">
                    <input class="primary-input" type="text" id="banner_image_file_1"
                           placeholder="{{__('common.browse_image_file')}}" readonly="">
                    <button class="" type="button">
                        <label class="primary-btn small fix-gr-bg" for="banner_image_1">{{__("common.browse")}} </label>
                        <input type="file" class="d-none image_file" accept="image/*" name="banner_image_1"
                               id="banner_image_1" data-name_id="#banner_image_file_1"
                               data-view_id="#banner_image_show_1">
                    </button>
                </div>
            ...
            <div class="form_img_div">
                <img id="banner_image_show_1"
                     src="{{ showImage($data->customSection->field_1?$data->customSection->field_1:'backend/img/default.png') }}"
                     alt="">
            </div>
        </div>
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="section_1_link"> {{__('frontendCms.section_1_link')}} <span
                            class="text-danger">*</span> </label>
                <input class="primary_input_field" type="text" id="section_1_link"
                       value="{{$data->customSection->field_4}}" name="section_1_link" autocomplete="off"
        ...
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="banner_image_file_2">{{__('frontendCms.section_image_2') }}
                    ({{getNumberTranslate(450)}} X {{getNumberTranslate(300)}}){{__('common.px')}}</label>
                <div class="primary_file_uploader">
                    <input class="primary-input" type="text" id="banner_image_file_2"
                           placeholder="{{__('common.browse_image_file')}}" readonly="">
                    <button class="" type="button">
                        <label class="primary-btn small fix-gr-bg" for="banner_image_2">{{__("common.browse")}} </label>
                        <input type="file" class="d-none image_file" accept="image/*" name="banner_image_2"
                               id="banner_image_2" data-name_id="#banner_image_file_2"
                               data-view_id="#banner_image_show_2">
                    </button>
                </div>
        ...
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="name"> {{__('frontendCms.section_2_link')}} <span
                            class="text-danger">*</span> </label>
                <input class="primary_input_field" type="text" id="section_2_link"
                       value="{{$data->customSection->field_5}}" name="section_2_link" autocomplete="off"
                       placeholder="{{__('common.link')}}">
        ...
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('frontendCms.section_image_3') }}
                    ({{getNumberTranslate(450)}} X {{getNumberTranslate(300)}}){{__('common.px')}}</label>
                <div class="primary_file_uploader">
                    <input class="primary-input" type="text" id="banner_image_file_3"
                           placeholder="{{__('common.browse_image_file')}}" readonly="">
                    <button class="" type="button">
                        <label class="primary-btn small fix-gr-bg" for="banner_image_3">{{__("common.browse")}} </label>
                        <input type="file" class="d-none image_file" accept="image/*" name="banner_image_3"
                               id="banner_image_3" data-name_id="#banner_image_file_3"
                               data-view_id="#banner_image_show_3">
                    </button>
                </div>
            ...
            <div class="form_img_div">
                <img id="banner_image_show_3"
                     src="{{ showImage($data->customSection->field_3?$data->customSection->field_3:'backend/img/default.png') }}"
                     alt="">
            </div>
        </div>
        <div class="col-lg-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="name"> {{__('frontendCms.section_3_link')}} <span
                            class="text-danger">*</span></label>
                <input class="primary_input_field" type="text" id="section_3_link"
                       value="{{$data->customSection->field_6}}" name="section_3_link" autocomplete="off"
                       placeholder="{{__('common.link')}}">
