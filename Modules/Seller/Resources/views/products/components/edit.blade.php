                        ...
                        <form action="{{route('seller.product.update',$product->id)}}" method="POST"
                                ...
                                <div class="col-lg-6">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label"
                                               for=""> {{__("product.i_want_to_manage_stock_for_this_product")}}</label>
                                        <label class="switch_toggle" for="checkbox1">
                                            <input type="checkbox" id="checkbox1"
                                                   @if ($product->stock_manage == 1) checked
                            ...
                            @if($product->product->product_type ==1)
                                <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" name="product_stock"
                                                       id="product_stock" placeholder="{{__("product.product_stock")}}"
                                                       type="number" min="0" step="0"
                                                       value="{{$product->skus->first()->product_stock??0}}" required>
                                                @error('product_stock')
                                    ...
                                    @endif
                                    <input type="hidden" id="stock_manage" name="stock_manage"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field" name="selling_price" id="selling_price"
                                                   ...
                                                   step="{{step_decimal()}}"
                                                   value="{{$product->skus->first()->selling_price?$product->skus->first()->selling_price:''}}"
                                                   required>
                                    ...
                                    @if(isModuleActive('WholeSale'))
                                        <div class="col-lg-6 whole_sale_info_add" id="whole_sale_info_add">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="">{{ __('wholesale.Wholesale Price') }}</label>
                                                <!-- table-responsive -->
                                                                ...
                                                                <tr class="whole_sale_price_list">
                                                                    <td class="p-2 border-0">
                                                                        <input type="text"
                                                                               ...
                                                                               value="{{ $wholesale_price->min_qty }}"
                                                                               name="wholesale_min_qty_0[]">
                                                                    </td>
                                                                    <td class="p-2 border-0">
                                                                        <input type="text"
                                                                               class="form-control primary_input_field"
                                                                               value="{{ $wholesale_price->max_qty }}"
                                                                               name="wholesale_max_qty_0[]">
                                                                    </td>
                                                                    <td class="p-2 border-0">
                                                                        <input type="text"
                                                                               class="form-control primary_input_field"
                                                                               value="{{ $wholesale_price->selling_price }}"
                                                                               name="wholesale_price_0[]">
                                                                    </td>
                                                                    <td class="p-2 pr-0 remove_whole_sale border-0">
                                                                        <button type="button"
                                                                                class="btn close style_close_icon"><span
                                            ...
                                            <div class="add_items_button mb-20">
                                                <button type="button"
                                                        class="btn btn-light btn-sm border add_single_whole_sale_price"> {{__('common.add_more')}} </button>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="row">
                                            ...
                                            <div role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="primary_input mb-15">
                                                            <label class="primary_input_label"
                                                                   for="product_name"> {{__("product.display_name")}}</label>
                                                            <input class="primary_input_field" id="product_name"
                                                                   name="product_name[{{$language->code}}]"
                                                                   placeholder="{{__("product.display_name")}}"
                                                                   type="text"
                                ...
                                <div class="col-lg-6">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label"
                                               for="thumbnail_image_file_seller">{{ __('product.thumbnail_image') }}
                                            ({{getNumberTranslate(165)}} x {{getNumberTranslate(165)}}
                                            ) {{__('common.px')}}</label>
                                        <div class="primary_file_uploader" data-toggle="amazuploader"
                                             data-multiple="false" data-type="image" data-name="thumbnail_image">
                                            ...
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="thumbnail_image_seller">{{ __('product.Browse') }} </label>
                                                <input type="hidden" class="selected_files"
                                                       value="{{@$product->thumb_image_media->media_id}}">
                                            </button>
                                        </div>
                                        <div class="product_image_all_div">
                                            @if(@$product->thumb_image_media == null && $product->thum_img != null)
                                                <div class="thumb_img_div">
                                                    <img id="ThumbnailImg"
                                                         src="{{showImage($product->thum_img != null?$product->thum_img:'backend/img/default.png')}}"
                                                         alt="">
                                                </div>
                                            @else
                                                <input type="hidden" class="product_images_hidden"
                                        ...
                                        <div class="primary_input mb-25">
                                            ...
                                            <select class="primary_select mb-25" name="product_sku" id="product_sku">
                                                <option value="" disabled
                                                        selected>{{__('seller.select_from_list')}}</option>
                                                @foreach($skus as $sku)
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="mt-25" id="sku_list_div">
                                            @foreach($product->skus as $sku)
                                                <li class="badge_1 mb-10"
                                                    id="badge_id_{{$sku->id}}">{{$sku->sku->sku}}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div id="variant_table_div" class="col-xl-12 overflow-auto">
                                        <table class="table table-bordered sku_table">
                                            ...
                                            @foreach($product->skus as $key => $item)
                                                ...
                                                <tr>
                                                    <input type="hidden" name="product_skus[]"
                                                           value="{{$item->sku->id}}">
                                                    ...
                                                    <td class="text-center sku_price_td">
                                                        <input class="primary_input_field" type="number"
                                                               name="selling_price_sku[]"
                                                               value="{{$item->selling_price}}" min="0"
                                                               step="{{step_decimal()}}" class="form-control" required>
                                                        @if (isModuleActive('WholeSale'))
                                                            <button type="button" data-toggle="modal" tabindex="-1"
                                                                    data-target="#variant_wholesale_price_modal_{{ $item->sku->sku.$key }}"
                                                            ...
                                                            <ul id="append_w_p{{$item->sku->sku.$key}}">
                                                                @foreach($wholesalePriceInfo as $w_s_p)
                                                                    <li>{{__('wholesale.Range')}}
                                                                        :{{($w_s_p->min_qty.'-'.$w_s_p->max_qty).'  $'.$w_s_p->selling_price}}</li>
                                                                @endforeach
                                                            </ul>
                                                    ...
                                                    @if ($product->stock_manage == 1)
                                                        <td class="text-center sku_price_td">
                                                            <input class="primary_input_field" type="number"
                                                                   name="stock[]" value="{{$item->product_stock}}"
                                                                   min="0" step="0" class="form-control" required>
                                                        </td>
                                                    @endif
                                                    <td class="text-center product_sku_name">
                                                        <label class="switch_toggle" for="checkbox_{{$item->id}}">
                                                            <input type="checkbox" name="status_{{$item->sku->id}}"
                                                                   id="checkbox_{{$item->id}}"
                                                                   {{$item->status?'checked':''}}  value="{{$item->id}}">
                                                            <div class="slider round"></div>
                                                        </label>
                                                    </td>
                                                    <td class="text-center sku_delete_td" data-id="{{$item->id}}"
                                                        data-unique_id="#badge_id_{{$item->id}}"><p><i
