                    ...
                    <div class="white_box box_shadow_white mb-20">
                        <div class="row">
                                    ...
                                    <ul id="theme_nav" class="permission_list sms_list ">
                                        <li>
                                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                                <input name="product_type" id="single_prod" value="1" disabled
                                        ...
                                        <li>
                                            <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                                <input name="product_type" value="2" id="variant_prod" disabled
                                                       {{$product->product_type == 2?'checked':''}}
                                    ...
                                    @foreach ($LanguageList as $key => $language)
                                        <li class="nav-item">
                                            <a class="nav-link default_lang anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                                               data-id="{{$language->code}}" href="#pnelement{{$language->code}}"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for="product_name"> {{ __('common.name') }} <span
                                                                    class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-3 {{$product->product_type == 2 ? '' : 'd-none'}} variant_sku_prefix">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label"
                                           for="variant_sku_prefix"> {{ __('product.variant_sku_prefix') }} <span
                                                class="text-danger">*</span></label>
                                    <input class="primary_input_field" name="variant_sku_prefix" id="variant_sku_prefix"
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input mb-25">
                                    ...
                                    @endphp
                                    <select name="category_ids[]" id="category_id" class="mb-15 category"
                                            @if(app('general_setting')->multi_category == 1) multiple
                                            @elseif(isset($product) && count($product->categories) > 1) multiple @endif>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <select name="brand_id" id="brand_id" class="mb-15 brand">
                                        ...
                                        @if(old('brand_id'))
                                            ...
                                            @endphp
                                            <option value="{{$old_selected_brand->id}}"
                                                    selected>{{$old_selected_brand->name}}</option>
                                        @elseif(isset($product))
                                            <option value="{{$product->brand_id}}"
                                                    selected>{{$product->brand->name}}</option>
                                        @endif
                                    </select>
                                    ...
                                    <select name="unit_type_id" id="unit_type_id" class="primary_select mb-15 unit">
                                        ...
                                        @foreach($units as $key => $unit)
                                            <option value="{{$unit->id}}"
                                                    @if ($product->unit_type_id == $unit->id) selected
                                ...
                                <div class="col-lg-6">
                                    <div class="primary_input mb-15">
                                        ...
                                        <input class="primary_input_field" name="club_point" id="club_point"
                                               placeholder="{{ __('clubpoint.point') }}" type="number" min="0"
                                               value="{{ @$product->club_point }}">
                                        <span class="text-danger"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="primary_input">
                                    <ul id="theme_nav" class="permission_list sms_list ">
                                        <li>
                                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                                <input name="" id="is_physical"
                                                       {{$product->is_physical == 1?'checked':''}}
                            ...
                            <div class="col-lg-12 weight_height_div">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('product.weight')}}
                                                [Gm]</label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('product.length')}}
                                                [Cm]</label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('product.breadth')}}
                                                [Cm]</label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('product.height')}}
                                                [Cm]</label>
                            ...
                            <div class="col-lg-12 digital_file_upload_div_edit"
                                 style="display: {{$product->is_physical == 0?'block':'none'}}">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label"
                            ...
                            <div id="phisical_shipping_div" class="col-lg-12"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="additional_shipping">{{ __('product.additional_shipping_charge') }}
                                            </label>
                                    ...
                                    @foreach ($LanguageList as $key => $language)
                                        <li class="nav-item">
                                            <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                                               href="#pelement{{$language->code}}" role="tab" data-toggle="tab"
                                               aria-selected="@if (auth()->user()->lang_code == $language->code) true @else false @endif">{{ $language->native }} </a>
                                        </li>
                                    @endforeach
                                </ul>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <div class="product_image_all_div">
                                        @if(@$product->meta_image_media->media_id)
                                            <input type="hidden" name="meta_image" class="product_images_hidden"
                                                   value="{{@$product->meta_image_media->media_id}}">
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="row image_section">
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
                                    ...
                                    <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="true"
                                    ...
                                    <div class="product_image_all_div">
                                        ...
                                        @foreach($media_ids as $media_id)
                                            <input type="hidden" name="images[]" class="product_images_hidden"
                                                   value="{{$media_id}}">
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <select class="primary_select mb-25" name="video_provider" id="video_provider">
                                        ...
                                        <option value="daily_motion"
                                                @if ($product->video_provider == "daily_motion") selected
                                        ...
                                        <li>
                                            <label data-id="bg_option"
                                                ...
                                                <input name="status" id="status_active" value="1"
                                                       @if (@$product->status == 1) checked @endif class="active"
                                                       type="radio">
                                                <span class="checkmark"></span>
                                            </label>
                                        ...
                                        <li>
                                            <label data-id="color_option"
                                                ...
                                                <input name="status" value="0" id="status_inactive"
                                                       @if (@$product->status == 0) checked @endif  class="de_active"
                                                       type="radio">
                                                <span class="checkmark"></span>
                                            </label>
