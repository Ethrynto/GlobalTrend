                            ...
                            <div class="col-xl-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label"
                                           for="product_types">{{ __('common.product_type') }}
                                        <span class="text-danger">*</span></label>
                                    <select class="primary_select mb-25" name="product_types" id="product_types"
                                            required>
                                        <option @if(!session()->has('seller_product_create_state') || session()->get('seller_product_create_state') == 2) selected
                                                @endif value="2">{{ __('product.existing_product') }}</option>
                                        <option @if(session()->has('seller_product_create_state') && session()->get('seller_product_create_state') == 1) selected
                                                @endif value="1">{{ __('product.new_product') }}</option>
                                    </select>
                                    <input type="hidden" id="seller_product_create_state"
                                           value="{{ session()->has('seller_product_create_state')?session()->get('seller_product_create_state'):2 }}">
                                </div>
                                ...
                                <form action="{{route('seller.product.store')}}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select class="mb-25 product_id" id="main_product_for_select"
                                                        name="product_id" required>
                                                    <option value="" selected
                                                            disabled>{{ __('common.select') }}</option>
                                        ...
                                        <div id="single_product_stock_manage_div" class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="product_stock_manage">{{__('product.product_stock_manage')}}
                                                    <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="product_stock">{{__('product.product_stock')}} <span
                                                            class="text-danger">*</span></label>
                                                <input class="primary_input_field" name="product_stock"
                                                       id="product_stock"
                                                       placeholder="{{__("product.product_stock")}}" type="number"
                                                       min="0"
                                            ...
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="product_sku">{{ __('product.select_product_sku') }} <span
                                                            class="text-danger">*</span></label>
                                                <select class="primary_select mb-25" name="product_sku []"
                                                        id="product_sku" multiple>
                                                    <option value="" selected
                                                            disabled>{{ __('common.select') }}</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                                ...
                                                @foreach ($LanguageList as $key => $language)
                                                    <li class="nav-item">
                                                        <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                                                           href="#epnelement{{$language->code}}" role="tab"
                                                           data-toggle="tab"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="">{{ __('product.thumbnail_image') }}
                                                    ({{getNumberTranslate(165)}} x {{getNumberTranslate(165)}}
                                                    ) {{__('common.px')}}</label>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="white_box box_shadow_white mb-20 p-15">
                                                <div class="row">
                                                            ...
                                                            <ul id="theme_nav" class="permission_list sms_list ">
                                                                <li>
                                                                    <label data-id="bg_option"
                                                                        ...
                                                                        <input name="product_type" id="single_prod"
                                                                               value="1" checked
                                                                ...
                                                                <li>
                                                                    <label data-id="color_option"
                                                                           class="primary_checkbox d-flex mr-12">
                                                                        <input name="product_type" value="2"
                                                                               id="variant_prod"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="primary_input mb-15">
                                                                                ...
                                                                                <input class="primary_input_field"
                                                                                       name="product_name[{{$language->code}}]"
                                                                                       id="product_name_new_{{$language->code}}"
                                                                                       placeholder="{{ __('common.name') }}"
                                                                                       type="text"
                                                                                       value="{{old('product_name.'.$language->code)}}">
                                                                                <span class="text-danger"
                                                                                      id="error_product_new_name_{{$language->code}}">{{ $errors->first('product_name') }}</span>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="col-lg-3 d-none variant_sku_prefix">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" name="variant_sku_prefix"
                                                                   ...
                                                                   placeholder="{{ __('product.variant_sku_prefix') }}"
                                                                   type="text" value="{{old('variant_sku_prefix')}}">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" name="model_number"
                                                                   placeholder="{{__("common.model_number")}}"
                                                                   type="text"
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="primary_input mb-25">
                                                            ...
                                                            <select name="category_ids[]" id="category_id"
                                                                    ...
                                                                    @if(app('general_setting')->multi_category == 1) multiple
                                                                    @endif required="1">

                                                            </select>
                                                            <span class="text-danger"
                                                                  id="error_category_ids">{{$errors->first('category_id')}}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="primary_input mb-25">
                                                            ...
                                                            <span
                                                                    class="text-danger"
                                                                    id="error_unit_type">{{$errors->first('unit_type_id')}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="primary_input mb-15">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" name="minimum_order_qty"
                                                                   id="minimum_order_qty" value="1" type="number"
                                                                   min="1"
                                                                   step="0" required="1">
                                                            <span
                                                                    class="text-danger"
                                                    ...
                                                    @if(isModuleActive('ClubPoint'))
                                                        <div class="col-lg-6">
                                                            <div class="primary_input mb-15">
                                                                ...
                                                                <input class="primary_input_field" name="club_point"
                                                                       id="club_point"
                                                                       placeholder="{{__('clubpoint.point') }}"
                                                                       type="number" min="0"
                                                                       value="{{old('club_point')?old('club_point'):0}}">
                                                                <span class="text-danger"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="single_field ">
                                                            <label for="">@lang('blog.tags')
                                                                (@lang('product.comma_separated'))<span
                                                                        class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="tagInput_field mb_26">
                                                            <input name="tags" class="tag-input"
                                                                   id="tag-input-upload-shots"
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="primary_input">
                                                            <ul id="theme_nav" class="permission_list sms_list ">
                                                                <li>
                                                                    <label data-id="bg_option"
                                                                           class="primary_checkbox d-flex mr-12">
                                                                        <input name="" id="is_physical" checked
                                                                               value="1"
                                                                               type="checkbox">
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                    ...
                                                    <div class="col-lg-12  weight_height_div">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for=""> {{ __('product.weight')}}[Gm]</label>
                                                                    <input class="primary_input_field" name="weight"
                                                                           id="weight"
                                                                           type="number" min="0"
                                                                           step="{{step_decimal()}}">
                                                                    <span class="text-danger"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for=""> {{ __('product.length')}}[Cm]</label>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for=""> {{ __('product.breadth')}}
                                                                        [Cm]</label>
                                                                    <input class="primary_input_field" name="breadth"
                                                                           id="breadth"
                                                                           type="number" min="0"
                                                                           step="{{step_decimal()}}">
                                                                    <span class="text-danger"
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for=""> {{ __('product.height')}}[Cm]</label>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" name="discount"
                                                                   id="discount"
                                                                   placeholder="{{__("product.discount")}}"
                                                                   type="number"
                                                    ...
                                                    @if (app('gst_config')['enable_gst'] == "only_tax")
                                                        <div class="col-lg-6">
                                                            <div class="primary_input mb-25">
                                                                ...
                                                                <select class="primary_select mb-25" name="tax_id"
                                                                        id="tax_id">
                                                                    <option value="" selected
                                                    ...
                                                    @else
                                                        <div class="col-lg-6">
                                                            <div class="primary_input mb-25">
                                                                ...
                                                                <select class="primary_select mb-25" name="gst_group"
                                                                        id="tax_type">
                                                                    <option value="" selected
                                                                            disabled>{{__('common.select_one')}}</option>
                                                    ...
                                                    @if (isModuleActive('WholeSale'))
                                                        <div class="col-lg-12 whole_sale_info_add"
                                                             id="whole_sale_info_add">
                                                            <h3 class="mb-2 mr-30">{{ __('wholesale.Wholesale Price') }}</h3>
                                                            <div class="QA_section2 QA_section_heading_custom check_box_table">
                                                                <div class="QA_table mb_15">
                                                                    <!-- table-responsive -->
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="meta_image_file">{{ __('product.meta_image') }}
                                                                (300x300)PX</label>
                                                            <div class="primary_file_uploader"
                                                                 data-toggle="amazuploader" data-multiple="false"
                                                                 data-type="image" data-name="meta_image">
                                                                <input class="primary-input file_amount" type="text"
                                                                       id="meta_image_file"
                                            ...
                                            <div class="white_box box_shadow_white p-15">
                                                <div class="row image_section">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-25">
                                                            <div class="primary_file_uploader"
                                                                 data-toggle="amazuploader" data-multiple="true"
                                                                 data-type="image" data-name="images[]">
                                                                <input class="primary-input file_amount" type="text"
                                                                       id="thumbnail_image_file"
                                                                       placeholder="{{__('common.choose_images') }}"
                                                                       readonly="">
                                                                <button class="" type="button">
                                                                    <label class="primary-btn small fix-gr-bg"
                                                                           for="thumbnail_image">{{__('product.Browse') }} </label>
                                                                    <input type="hidden"
                                                                           class="selected_files image_selected_files"
                                                                           value="">
                                                                </button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="pdf_place">{{__('product.pdf_specifications')}}</label>
                                                            <div class="primary_file_uploader">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" id="video_link"
                                                                   name="video_link"
                                                                   placeholder="{{__("product.video_link")}}"
                                                                   type="text" value="{{old('video_link')}}">
                                                            <span
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('common.status') }} <span
                                                                        class="text-danger">*</span></label>
                                                            <ul id="theme_nav" class="permission_list sms_list ">
                                                                <li>
                                                                    <label data-id="bg_option"
                                                                           class="primary_checkbox d-flex mr-12">
                                                                        <input name="status" id="status_active"
                                                                               value="1" checked class="active"
                                                                               type="radio">
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('common.make_Display_in_details_page') }}
                                                                <span class="text-danger">*</span></label>
                                                            <ul id="theme_nav" class="permission_list sms_list ">
                                                                <li>
                                                                    <label data-id="bg_option"
                                                                           class="primary_checkbox d-flex mr-12">
                                                                        <input name="display_in_details"
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $(document).on('change', '#product_sku', function () {
                    ...
                    var stock_manage = $('#stock_manage').val();
                    $.post('{{ route('seller.product.variant') }}', {
                        _token: '{{ csrf_token() }}',
                        ids: a_id,
                ...
                $(document).on('click', '.wholesale_p_save_btn', function () {
                    ...
                    var wholesale_min_qty_v = $('input[name="wholesale_min_qty_v_' + w_incKey + '[]"]').map(function () {
                        return $(this).val();
                    }).get();
                    var wholesale_max_qty_v = $('input[name="wholesale_max_qty_v_' + w_incKey + '[]"]').map(function () {
                        return $(this).val();
                    }).get();
                    var wholesale_price_v = $('input[name="wholesale_price_v_' + w_incKey + '[]"]').map(function () {
                        return $(this).val();
                    }).get();
