...
@section('mainContent')
    <!-- Modal -->
    <div class="modal fade" id="modal_ameria_cancel_payment" tabindex="-1" role="dialog" aria-labelledby="modal_ameria_cancel_payment" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span class="text-danger">Attention: this function is available within 72 hours starting from creating an order </span>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <form action="/ordermanage/order-ameria/cancel" method="POST">
                        @csrf
                        <input type="hidden" name="payment_id" value="{{@$order->order_payment->txn_id }}">
    ...
    <div class="modal fade" id="modal_ameria_refund_payment" tabindex="-1" role="dialog" aria-labelledby="modal_ameria_cancel_payment" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
                ...
                <div class="modal-body">
                    <span class="text-danger">Attention: this amount shall not exceed the order amount.</span>
                    <form action="/ordermanage/order-ameria/refund" method="POST" id="ameria_refund_form">
                        @csrf
                        <input type="hidden" name="payment_id" value="{{@$order->order_payment->txn_id }}">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onClick="submit_ameria_refund()">Submit</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-8 student-details">
                        <div class="white_box_50px box_shadow_white" id="printableArea">
                            ...
                            <div class="row mt-30">
                                ...
                                @endif
                                @if (@$order->order_payment->payment_method == 15)
                                    <div class="col-md-6 col-lg-6 mt-2">
                                        <button type="button" class="btn btn-danger mx-1" data-toggle="modal" data-target="#modal_ameria_cancel_payment">
                                            Cancel Payment
                                        </button>
                                        <button type="button" class="btn btn-danger mx-1" data-toggle="modal" data-target="#modal_ameria_refund_payment">
                                            Refund Payment
                                        </button>
                                    </div>
                                @endif
...
@push('scripts')
    <script type="text/javascript">
        ...
        function submit_ameria_refund() {
            let ameria_refund_form = $('#ameria_refund_form');
            ameria_refund_form.submit();
        }
    </script>
@endpush
