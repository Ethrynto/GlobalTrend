...
Route::prefix('ordermanage')->middleware(['auth','seller'])->group(function () {
    ...
    Route::middleware(['auth','admin'])->group(function () {
        ...
        Route::prefix('/order-ameria')->group(function () {
            Route::post('/refund', 'OrderManageController@ameriaRefund')->name('order_manage.order_ameria.refund');
            Route::post('/cancel', 'OrderManageController@ameriaCancel')->name('order_manage.order_ameria.cancel');
        });
        // configurateion
