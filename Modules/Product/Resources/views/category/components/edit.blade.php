        ...
        <div class="add-visitor">
            <div class="row">
                            ...
                            <div role="tabpanel"
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <input class="primary_input_field name" type="text"
                                           id="name{{auth()->user()->lang_code == $language->code?$language->code:''}}"
                                           name="name[{{$language->code}}]" autocomplete="off"
                                           placeholder="{{__('common.name')}}"
                                           value="{{isset($category)?$category->getTranslation('name',$language->code):old('name.'.$language->code)}}">
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <input class="primary_input_field slug" type="text" id="slug" name="slug" autocomplete="off"
                               value="{{$category->slug}}" placeholder="{{__('common.slug')}}">
                    </div>
                ...
                @if(isModuleActive('GoogleMerchantCenter'))
                    <div class="col-lg-12">
                        <div class="primary_input mb-25">
                            ...
                            <input class="primary_input_field google_product_category_id" type="number" min="0"
                                   step="{{step_decimal()}}" value="{{$category->google_product_category_id}}"
                                   id="google_product_category_id" name="google_product_category_id" autocomplete="off"
                                   placeholder="{{__('product.google_product_category_id')}}">
                    ...
                    <div class="col-lg-12">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label"
                                   for="commission_rate">{{__('common.commission_rate')}}</label>
                            <input class="primary_input_field commission_rate" type="number" min="0"
                                   step="{{step_decimal()}}" id="commission_rate" name="commission_rate"
                                   value="{{$category->commission_rate}}" autocomplete="off"
                        ...
                        <ul id="theme_nav" class="permission_list sms_list ">
                            <li>
                                <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="searchable" id="searchable_active" value="1"
                                           {{$category->searchable == 1?'checked':''}}
                            ...
                            <li>
                                <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="searchable" id="searchable_inactive" value="0"
                                           {{$category->searchable == 0?'checked':''}} class="de_active" type="radio">
                                    <span class="checkmark"></span>
                                </label>
                            ...
                            <li>
                                <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="status" id="status_active" value="1"
                                           {{$category->status==1?'checked':''}} class="active"
                                           type="radio">
                                    <span class="checkmark"></span>
                                </label>
                                <p>{{ __('common.active') }}</p>
                            ...
                            <li>
                                <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="status" value="0" id="status_inactive"
                                           {{$category->status==0?'checked':''}} class="de_active" type="radio">
                                    <span class="checkmark"></span>
                                </label>
                                <p>{{ __('common.inactive') }}</p>
                            </li>
                        ...
                        <ul id="theme_nav" class="permission_list sms_list ">
                            <li>
                                <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                    <input class="in_sub_cat" name="category_type" id="sub_cat" value="subCategory"
                                           {{$category->parent_id !=0?'checked':'' }} type="checkbox">
                                    <span class="checkmark"></span>
                                </label>
                        ...
                        <select class="mb-25" name="parent_id" id="parent_id">
                            @if($category->parent_id != 0)
                                <option value="{{$category->parent_id}}"
                                        selected>{{@$category->parentCategory->name}}</option>
                            @endif
                        </select>
                        <span class="text-danger"></span>
                    </div>
                ...
                <div class="col-xl-12 upload_photo_div">
                    <div class="primary_input">
                        <label class="primary_input_label">{{__('common.upload_photo')}} ({{getNumberTranslate(225)}}
                            X {{getNumberTranslate(225)}}){{__('common.px')}}</label>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="false"
                             data-type="image" data-name="category_image">
                            <input class="primary-input file_amount" type="text" id="image"
                            ...
                            <button class="" type="button">
                                ...
                                <input type="hidden" class="selected_files"
                                       value="{{@$category->categoryImage->category_image_media->media_id}}">
                            </button>
                        </div>
                        <div class="product_image_all_div">
                            @if(@$category->categoryImage->category_image_media->media_id)
                                <input type="hidden" name="category_image" class="product_images_hidden"
                                       value="{{@$category->categoryImage->category_image_media->media_id}}">
                            @endif
                        </div>
                    </div>
            ...
            <div class="row mt-40">
                <div class="col-lg-12 text-center">
                    <button id="create_btn" type="submit" class="primary-btn fix-gr-bg submit_btn" data-toggle="tooltip"
                            title=""
                            data-original-title="">
