            ...
            <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="tab-content">
                                ...
                                <div class="white_box_50px box_shadow_white mb-20 pt-0 p-15">
                                    <div class="row">
                                        <ul class="nav nav-tabs justify-content-start mt-sm-md-20 mb-30 grid_gap_5"
                                            ...
                                            @foreach ($LanguageList as $key => $language)
                                                <li class="nav-item">
                                                    <a class="nav-link default_lang anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                                                       data-id="{{$language->code}}"
                                                       href="#pnelement{{$language->code}}" role="tab"
                                                       data-toggle="tab"
                                        ...
                                        <div class="col-lg-12">
                                            <input type="hidden" value="{{ $product->product_type }}"
                                                   id="product_type">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                       for=""><strong>{{__('common.type') }}</strong>@if($product->product_type == 2)
                                                        ({{__('product.variant_product_is_not_changable_to_single_product')}}
                                                        )
                                                    @elseif($product->product_type == 1 && !product_attribute_editable($product->id))
                                                        ({{__('product.change_not_possible_for_use')}})
                                                    @endif<span class="text-danger">*</span></label>
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    <li>
                                                        <label data-id="bg_option"
                                                               class="primary_checkbox d-flex mr-12">
                                                            <input name="product_type" id="single_prod" value="1"
                                                                   {{$product->product_type == 1?'checked':''}} {{($product->product_type == 2 || !product_attribute_editable($product->id))?'disabled':''}}
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                            ...
                                                            <input name="product_type" value="2" id="variant_prod"
                                                                   {{$product->product_type == 2?'checked':''}} {{($product->product_type == 2 || !product_attribute_editable($product->id))?'disabled':''}}
                                            ...
                                            <div class="tab-content">
                                                @foreach ($LanguageList as $key => $language)
                                                    <div role="tabpanel"
                                                         ...
                                                         id="pnelement{{$language->code}}">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for="product_name"> {{ __('common.name') }}
                                                                        <span class="text-danger">*</span></label>
                                                                    <input class="primary_input_field"
                                                                           name="product_name[{{$language->code}}]"
                                                                           id="product_name_{{$language->code}}"
                                                                           placeholder="{{ __('common.name') }}"
                                                                           type="text"
                                                                           value="{{isset($product)?$product->getTranslation('product_name',$language->code):old('product_name.'.$language->code)}}">
                                                                    <span class="text-danger"
                                                                          id="error_product_name_{{$language->code}}">{{ $errors->first('product_name') }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 sku_single_div d-none"
                                                                 id="default_lang_{{$language->code}}">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for="sku_single"> {{ __('product.product_sku') }}</label>
                                                                    <input class="primary_input_field"
                                                                           name="product_sku[{{$language->code}}]"
                                                                           id="sku_single"
                                                                           placeholder="{{ __('product.product_sku') }}"
                                                                           type="text"
                                                                           value="{{isset($product)?$product->skus->first()->sku:old('product_sku.'.$language->code)}}">
                                                                    <span id="error_single_sku"
                                                                          class="text-danger">{{ $errors->first('product_sku') }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for="subtitle_1"> {{ __('product.subtitle_1') }}</label>
                                                                    <input class="primary_input_field"
                                                                           name="subtitle_1[{{$language->code}}]"
                                                                           id="subtitle_1"
                                                                           placeholder="{{ __('product.subtitle_1') }}"
                                                                           type="text"
                                                                           value="{{isset($product)?$product->getTranslation('subtitle_1',$language->code):old('subtitle_1.'.$language->code)}}">
                                                                    <span id="error_subtitle_1"
                                                                          class="text-danger">{{ $errors->first('subtitle_1') }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                                <div class="primary_input mb-15">
                                                                    <label class="primary_input_label"
                                                                           for="subtitle_2"> {{ __('product.subtitle_2') }}</label>
                                                                    <input class="primary_input_field"
                                                                           name="subtitle_2[{{$language->code}}]"
                                                                           id="subtitle_2"
                                                                           placeholder="{{ __('product.subtitle_2') }}"
                                                                           type="text"
                                                                           value="{{isset($product)?$product->getTranslation('subtitle_2',$language->code):old('subtitle_2.'.$language->code)}}">
                                                                    <span id="error_subtitle_2"
                                                                          class="text-danger">{{ $errors->first('subtitle_2') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 {{$product->product_type == 2 ? '' : 'd-none'}} variant_sku_prefix">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="variant_sku_prefix"> {{ __('product.variant_sku_prefix') }}
                                                    <span class="text-danger">*</span></label>
                                                <input class="primary_input_field" name="variant_sku_prefix"
                                                       id="variant_sku_prefix"
                                                       placeholder="{{ __('product.variant_sku_prefix') }}" type="text"
                                                       value="{{ $product->variant_sku_prefix }}">
                                                <span id="error_variant_sku_prefix"
                                                      class="text-danger">{{ $errors->first('variant_sku_prefix') }}</span>
                                            </div>
                                        </div>
                                        <input type="hidden" name="new_attribute_added" id="new_attribute_added_id"
                                               value="0">
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                ...
                                                <select name="barcode_type" id="barcode_type"
                                                    ...
                                                    @foreach (barcodeList() as $key => $barcode)
                                                        <option value="{{ $barcode }}"
                                                                @if($barcode == @$product->skus->first()->barcode_type) selected @endif>{{ $barcode }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="minimum_order_qty"
                                                       ...
                                                       step="0" required="1">
                                                <span class="text-danger"
                                                      id="error_minumum_qty">{{ $errors->first('minimum_order_qty') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                        ...
                                        @if(isModuleActive('GoogleMerchantCenter'))
                                            <div class="col-lg-3">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label"
                                                           for="condition">{{ __('product.product_condition')}}</label>
                                                    <select class="primary_select mb-25" name="condition"
                                                            id="condition">
                                                        <option value="new"
                                                                @if($product->condition == 'new') selected @endif>{{ __('product.new') }}</option>
                                                        <option value="used"
                                                                @if($product->condition == 'used') selected @endif>{{ __('product.used') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                        ...
                                        @if(isModuleActive('ClubPoint'))
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    <label class="primary_input_label"
                                                           for="club_point">{{ __('clubpoint.point') }}</label>
                                                    <input class="primary_input_field" name="club_point" id="club_point"
                                                           placeholder="{{ __('clubpoint.point') }}" type="number"
                                                           min="0" value="{{ @$product->club_point }}">
                                                    <span class="text-danger"
                                                          id="error_discunt">{{ $errors->first('club_point') }}</span>
                                                </div>
                                            </div>
                                        @endif
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label for="">@lang('blog.tags') (@lang('product.comma_separated'))<span
                                                            class="text-danger">*</span></label>
                                                ...
                                                <span class="text-danger"
                                                      id="error_tags">{{ $errors->first('tags') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 attribute_div">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for=""><strong>{{ __('product.attribute') }}</strong> @if(!product_attribute_editable($product->id))
                                                        ({{__('product.attribute_add_not_possible_for_this_product')}})
                                                    @endif</label>
                                                <select name="choice_attributes[]" id="choice_attributes"
                                                        @if(!product_attribute_editable($product->id)) disabled @endif
                                                        class="primary_select mb-15">
                                                    <option value="" disabled
                                                            selected>{{ __('product.select_attribute') }}</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <input type="hidden" name="choice_no[]"
                                                                   id="attribute_id_{{$choice_option->attribute_id}}"
                                                                   value="{{ $choice_option->attribute_id }}">
                                                            <div class="primary_input mb-25">
                                                                <input class="primary_input_field" width="40%"
                                                                ...
                                                                <select name="choice_options_{{ $choice_option->attribute_id }}[]"
                                                                    ...
                                                                    @foreach ($choice_option->attribute->values as $key => $value)
                                                                        <option value="{{ $value->id }}"
                                                                                @if ($product->variations->where('attribute_value_id', $value->id)->first()) selected @endif> {{ $value->color ? $value->color->name : $value->value }} </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        @if(product_attribute_editable($product->id))
                                                            <div class="col-lg-1 text-center">
                                                                <a class="btn cursor_pointer attribute_remove"><i
                                                                            class="ti-trash"></i></a>
                                                            </div>
                                                        @endif
                                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="primary_input">
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    <li>
                                                        ...
                                                        <input type="hidden" name="is_physical" id="is_physical_prod"
                                                               value="{{$product->is_physical}}">
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="col-lg-12 weight_height_div">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for="weight"> {{__('product.weight')}}
                                                            [{{__('product.gm')}}]</label>
                                                        <input value="{{@$product->skus->first()->weight}}"
                                                               class="primary_input_field" name="weight" id="weight"
                                                               type="number" min="0" step="{{step_decimal()}}">
                                                        <span class="text-danger"
                                                              id="error_weight">{{ $errors->first('weight') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for="length"> {{ __('product.length')}}
                                                            [{{__('product.cm')}}]</label>
                                                        <input value="{{@getNumberTranslate($product->skus->first()->length)}}"
                                                               class="primary_input_field" name="length" id="length"
                                                               type="number" min="0" step="{{step_decimal()}}">
                                                        <span class="text-danger"
                                                              id="error_length">{{ $errors->first('length') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for=""> {{ __('product.breadth')}} [{{__('product.cm')}}
                                                            ]</label>
                                                        <input value="{{@$product->skus->first()->breadth}}"
                                                               class="primary_input_field" name="breadth" id="breadth"
                                                               type="number" min="0" step="{{step_decimal()}}">
                                                        <span class="text-danger"
                                                              id="error_breadth">{{ $errors->first('breadth') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for=""> {{ __('product.height')}} [{{__('product.cm')}}
                                                            ]</label>
                                                        <input value="{{@$product->skus->first()->height}}"
                                                               class="primary_input_field" name="height" id="height"
                                                               type="number" min="0" step="{{step_decimal()}}">
                                                        <span class="text-danger"
                                                              id="error_height">{{ $errors->first('height') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 digital_file_upload_div_edit"
                                             style="display: {{($product->is_physical == 1 || $product->product_type == 2)?'none':'block'}};">
                                            <div class="primary_input mb-25">
                                                @php
                                                    $digital_file = @$product->skus->first()->digital_file->file_source;
                                                @endphp
                                                <label class="primary_input_label"
                                                       for="pdf_place">{{ __('product.program_file_upload') }}
                                                    <small> @if($digital_file)
                                                            <a class="link_color"
                                                               href="{{ asset(asset_path(@$product->skus->first()->digital_file->file_source)) }}"
                                                               download>{{__('product.download_link')}}</a>
                                                        @endif </small> </label>
                                                <div class="primary_file_uploader">
                                                    ...
                                                    <button class="" type="button">
                                                        ...
                                                        <input type="file" class="d-none" name="single_digital_file"
                                                               id="pdf">
                                                    </button>
                                                </div>
                                        ...
                                        <div id="phisical_shipping_div" class="col-lg-12"
                                             style="display: {{$product->is_physical == 0?'none':'block'}}">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for="additional_shipping"> {{ __('product.additional_shipping_charge') }} </label>
                                                        <input class="primary_input_field" name="additional_shipping"
                                                               placeholder="{{__('product.additional_shipping_charge') }}"
                                                               type="number" min="0" step="{{step_decimal()}}"
                                        ...
                                        @if(!isModuleActive('MultiVendor'))
                                            ...
                                            <div class="col-lg-12" id="stock_manage_div">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label"
                                                           for="stock_manage">{{__('product.stock_manage') }}</label>
                                            ...
                                            <div class="col-lg-6 d-none" id="single_stock_div">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="single_stock"
                                                           id="single_stock"
                                            ...
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for="">
                                                    {{ __('product.selling_price') }} <span
                                                            class="text-danger">*</span></label>
                                                <input class="primary_input_field selling_price" name="selling_price"
                                                       id="selling_price"
                                                       ...
                                                       required>
                                                <span class="text-danger"
                                                      id="error_selling_price">{{ $errors->first('selling_price') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="discount"> {{ __('product.discount') }}</label>
                                                <input class="primary_input_field" name="discount" id="discount"
                                                       placeholder="{{ __('product.discount') }}" type="number" min="0"
                                                       step="{{step_decimal()}}"
                                                       value="{{getNumberTranslate(@$product->discount)}}">
                                                <span class="text-danger"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select class="primary_select mb-25" name="discount_type"
                                                        id="discount_type">
                                                    <option value="1"
                                                            @if ($product->discount_type == 1) selected @endif>{{ __('common.amount') }}</option>
                                                    <option value="0"
                                                            @if ($product->discount_type == 0) selected @endif>{{ __('common.percentage') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        @if (app('gst_config')['enable_gst'] == "only_tax")
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label"
                                                           for="tax_id">{{ __('common.tax')}}</label>
                                                    <select class="primary_select mb-25" name="tax_id" id="tax_id">
                                                        <option value="" selected
                                                                disabled>{{__('common.select_one')}}</option>
                                        ...
                                        @if(($product->product_type==1) && isModuleActive('WholeSale') && !isModuleActive('MultiVendor'))
                                            <div class="col-lg-12 whole_sale_info_add" id="whole_sale_info_add">
                                                                    ...
                                                                    <tr class="whole_sale_price_list">
                                                                        <td class="pl-0 pb-0 pr-3 border-0">
                                                                            <input type="text"
                                                                                   ...
                                                                                   placeholder="Min QTY"
                                                                                   name="wholesale_min_qty_0[]">
                                                                        </td>
                                                                        <td class="pl-0 pb-0 pr-3 border-0">
                                                                            <input type="text"
                                                                                   class="form-control primary_input_field"
                                                                                   placeholder="Max QTY"
                                                                                   name="wholesale_max_qty_0[]">
                                                                        </td>
                                                                        <td class="pl-0 pb-0  border-0">
                                                                            <input type="text"
                                                                                   class="form-control primary_input_field"
                                                                                   placeholder="Price per piece"
                                                                                   name="wholesale_price_0[]">
                                                                        </td>
                                                                    </tr>
                                                                @endif
                                                                    ...
                                                                    <tr class="whole_sale_price_list whole_sale_price_list_child">
                                                                        <td class="pl-0 pb-0 pr-3 border-0">
                                                                            <input type="text"
                                                                                   class="form-control primary_input_field"
                                                                                   name="wholesale_min_qty_0[]"
                                                                                   value="{{ $w_sale_price->min_qty }}">
                                                                        </td>
                                                                        <td class="pl-0 pb-0 pr-3 border-0">
                                                                            <input type="text"
                                                                                   class="form-control primary_input_field"
                                                                                   name="wholesale_max_qty_0[]"
                                                                                   value="{{ $w_sale_price->max_qty }}">
                                                                        </td>
                                                                        <td class="pl-0 pb-0 pr-3 border-0">
                                                                            <input type="text"
                                                                                   class="form-control primary_input_field"
                                                                                   name="wholesale_price_0[]"
                                                                                   value="{{ $w_sale_price->selling_price }}">
                                                                        </td>
                                                                        <td class="pl-0 pb-0 remove_whole_sale border-0">
                                                                            <button type="button"
                                                                                    class="btn close style_close_icon">
                                                ...
                                                <div class="add_items_button mb-20">
                                                    <button type="button"
                                                            class="btn btn-light btn-sm border add_single_whole_sale_price"> {{__('wholesale.Add More')}} </button>
                                                </div>
                                            </div>
                                        @endif
                                        <!-- End Whole-Sale -->
                                        <div class="col-lg-12">
                                            <div class="tab-content">
                                                @foreach ($LanguageList as $key => $language)
                                                    <div role="tabpanel"
                                                         class="tab-pane fade pelement @if (auth()->user()->lang_code == $language->code) show active @endif"
                                                         id="pelement{{$language->code}}">
                                                        <div class="col-lg-12">
                                                            <div class="main-title d-flex">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="primary_input mb-15">
                                                                    <textarea class="summernote"
                                                                              name="description[{{$language->code}}]"> {{isset($product)?$product->getTranslation('description',$language->code):old('description.'.$language->code)}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="main-title d-flex">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="primary_input mb-15">
                                                                    <textarea class="summernote2" id="specification"
                                                                              name="specification[{{$language->code}}]">{{isset($product)?$product->getTranslation('specification',$language->code):old('specification.'.$language->code)}}</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="primary_input mb-15">
                                                                <label class="primary_input_label"
                                                                       for="meta_title"> {{ __('common.meta_title')}}</label>
                                                                <input class="primary_input_field" id="meta_title"
                                                                       name="meta_title[{{$language->code}}]"
                                                                       placeholder="{{ __('common.meta_title') }}"
                                                                       type="text"
                                                                       value="{{isset($product)?$product->getTranslation('meta_title',$language->code):old('meta_title.'.$language->code)}}">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="primary_input mb-15">
                                                                <label class="primary_input_label"
                                                                       for="meta_description"> {{ __('common.meta_description') }}</label>
                                                                <textarea
                                                                        ...
                                                                        spellcheck="false">{{isset($product)?$product->getTranslation('meta_description',$language->code):old('meta_description.'.$language->code)}}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">{{__('product.meta_image') }}
                                                    ({{getNumberTranslate(300)}} X {{getNumberTranslate(300)}}
                                                    ){{__('common.px')}}</label>
                                                <div class="primary_file_uploader" data-toggle="amazuploader"
                                                     data-multiple="false" data-type="image" data-name="meta_image">
                                                    ...
                                                    <button class="" type="button">
                                                        ...
                                                        <input type="hidden" class="selected_files"
                                                               value="{{@$product->meta_image_media->media_id}}">
                                                    </button>
                                                </div>
                                ...
                                <div class="white_box p-15 box_shadow_white pt-0">
                                    <div class="row image_section">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <div class="primary_file_uploader" data-toggle="amazuploader"
                                                     data-multiple="true" data-type="image" data-name="images[]">
                                                    ...
                                                    <button class="" type="button">
                                                        ...
                                                        <input type="hidden" class="selected_files image_selected_files"
                                                               value="{{$product->media_ids}}">
                                                    </button>
                                                ...
                                                <div class="product_image_all_div">
                                                    ...
                                                    @foreach($media_ids as $media_id)
                                                        <input type="hidden" name="images[]"
                                                               class="product_images_hidden" value="{{$media_id}}">
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="pdf_place1">{{ __('product.pdf_specifications') }}</label>
                                                <div class="primary_file_uploader">
                                            ...
                                            @if(@$product->pdf)
                                                <a class="float-left anchore_color"
                                                   href="{{ asset(asset_path($product->pdf)) }}"
                                            ...
                                            <div class="primary_input mb-25">
                                                ...
                                                <select class="primary_select mb-25" name="video_provider"
                                                    ...
                                                    <option value="youtube"
                                                            @if ($product->video_provider == 'youtube') selected @endif>{{ __('product.youtube') }}</option>
                                                    <option value="daily_motion"
                                                            @if ($product->video_provider == 'daily_motion') selected @endif>{{ __('product.daily_motion') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="video_link">{{ __('product.video_link') }}</label>
                                                <input class="primary_input_field" id="video_link" name="video_link"
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                            ...
                                                            <input name="status" value="0" id="status_inactive"
                                                                   ...
                                                                   @endif  class="de_active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                               class="primary_checkbox d-flex mr-12">
                                                            <input name="status" value="3" id="defat_status"
                                                                   @if (@$product->status == 3) checked
                                                                   @endif  class="de_active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <p>{{ __('common.draft') }}</p>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                       for="">{{ __('common.make_Display_in_details_page') }} <span
                                                            class="text-danger">*</span></label>
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    <li>
                                                        <label data-id="bg_option"
                                                               class="primary_checkbox d-flex mr-12">
                                                            <input name="display_in_details" id="status_active"
                                                                   value="1"
                                                                   @if ($product->display_in_details == 1) checked
                                                                   @endif class="active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                               class="primary_checkbox d-flex mr-12">
                                                            <input name="display_in_details" value="2"
                                                                   id="status_inactive"
                                                                   @if ($product->display_in_details == 2) checked
                                                                   @endif class="de_active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                        ...
                                        @if(isModuleActive('GoldPrice'))
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label">{{__('product.auto_update_required') }}
                                                        <span class="text-danger">*</span></label>
                                                    <ul id="theme_nav" class="permission_list sms_list ">
                                                        <li>
                                                            <label data-id="bg_option"
                                                                   class="primary_checkbox d-flex mr-12">
                                                                <input name="auto_update_required"
                                                                       id="auto_update_required_active" value="1"
                                                                       {{$product->auto_update?'checked':''}} class="active"
                                                                       type="radio">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <p>{{ __('common.on') }}</p>
                                                        ...
                                                        <li>
                                                            <label data-id="color_option"
                                                                   class="primary_checkbox d-flex mr-12">
                                                                <input name="auto_update_required" value="0"
                                                                       id="auto_update_required_inactive"
                                                                       {{!$product->auto_update?'checked':''}} class="de_active"
                                                                       type="radio">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <p>{{ __('common.off') }}</p>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label"
                                                           for="gold_price_id">{{__('product.gold_price')}}</label>
                                                    <select class="primary_select mb-25" name="gold_price_id"
                                                            id="gold_price_id">
                                                        @foreach($gold_prices as $gold_price)
                                                            <option data-price="{{$gold_price->price}}"
                                                                    {{$product->gold_price_id == $gold_price->id?'selected':''}} value="{{$gold_price->id}}">{{$gold_price->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    <label class="primary_input_label"
                                                           for="making_charge"> {{__('product.making_charge') }}
                                                    </label>
                                                    <input class="primary_input_field" name="making_charge"
                                                           id="making_charge" placeholder="-" type="number" min="0"
                                                           step="{{step_decimal()}}"
                                                           value="{{$product->making_charge}}">
                                                    <span class="text-danger"
                                                          id="error_making_charge">{{ $errors->first('making_charge')}}</span>
                                                </div>
                                            </div>
                                        @endif
                                                    ...
                                                    <th scope="col">
                                                        <label class="primary_checkbox d-flex">
                                                            <input name="related_product[]"
                                                                   id="related_product_{{$key}}" checked
                                                                   value="{{$relatedSale->main_product->id}}"
                                                                   type="checkbox" class="related_product_checked">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </th>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="UpSale">
                        ...
                        <input class="primary_input_field" placeholder="Quick Search" type="text"
                               id="upsale_search_products">
                        <div class="QA_section QA_section_heading_custom check_box_table">
                                        ...
                                        @if(count(@$upSales) > 0)
                                            @foreach ($upSales as $key => $upSale)
                                                <tr>
                                                    <th scope="col">
                                                        <label class="primary_checkbox d-flex">
                                                            <input name="up_sale[]" id="up_sale_{{$key}}" checked
                                                                   value="{{$upSale->main_product->id}}" type="checkbox"
                                                                   class="upsale_product_checked">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </th>
                                        ...
                                        @if(count(@$crossSales) > 0)
                                            @foreach ($crossSales as $key => $crossSale)
                                                <tr>
                                                    <th scope="col">
                                                        <label class="primary_checkbox d-flex">
                                                            <input name="cross_sale[]" id="cross_sale_{{$key}}" checked
                                                                   value="{{$crossSale->main_product->id}}"
                                                                   type="checkbox" class="crosssale_product_checked">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </th>
