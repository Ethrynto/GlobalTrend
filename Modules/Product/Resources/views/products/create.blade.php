                                    ...
                                    <div class="row">
                                            ...
                                            @foreach ($LanguageList as $key => $language)
                                                <li class="nav-item">
                                                    <a class="nav-link default_lang anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                                                       ...
                                                       href="#pnelement{{$language->code}}" role="tab" data-toggle="tab"
                                                    ...
                                                    <li>
                                                        <label data-id="bg_option"
                                                            ...
                                                            <input name="product_type" id="single_prod" value="1"
                                                                   @if(!old('product_type') || old('product_type') == 1)checked
                                                                   @endif class="active prod_type" type="radio">
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                            ...
                                                            <input name="product_type" value="2" id="variant_prod"
                                                                   @if(old('product_type') && old('product_type') == 2)checked
                                                                   @endif class="de_active prod_type" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field"
                                                                           ...
                                                                           type="text"
                                                                           value="{{old('product_name.'.$language->code)}}">
                                                            ...
                                                            <div class="col-lg-6 sku_single_div d-none"
                                                                ...
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field"
                                                                           ...
                                                                           type="text"
                                                                           value="{{old('product_sku.'.$language->code)}}">
                                                            ...
                                                            <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field"
                                                                           ...
                                                                           type="text"
                                                                           value="{{old('subtitle_1.'.$language->code)}}">
                                                            ...
                                                            <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field"
                                                                           ...
                                                                           type="text"
                                                                           value="{{old('subtitle_2.'.$language->code)}}">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" id="model_number" name="model_number"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="barcode_type">{{ __('product.barcode_type')}}</label>
                                                <select name="barcode_type" id="barcode_type"
                                                        class="primary_select mb-15">
                                                    <option disabled>{{ __('product.select_barcode') }}</option>
                                                    @foreach (barcodeList() as $key => $barcode)
                                                        <option value="{{ $barcode }}"
                                                                @if(old('barcode_type') == $barcode) selected
                                                                @elseif($key==0) selected @endif>{{ $barcode }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="minimum_order_qty"> {{__('product.minimum_order_qty') }}
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <input class="primary_input_field" name="minimum_order_qty"
                                                       id="minimum_order_qty"
                                                       value="{{old('minimum_order_qty')?old('minimum_order_qty'):1}}"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="max_order_qty"> {{ __('product.max_order_qty')}}</label>
                                                <input class="primary_input_field" id="max_order_qty"
                                                       name="max_order_qty" type="number" min="0" step="0"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <select class="primary_select mb-25" name="condition"
                                                            id="condition">
                                                        <option value="new"
                                                                @if(old('condition') && old('condition') == 'new') selected @endif>{{ __('product.new') }}</option>
                                                        <option value="used"
                                                                @if(old('condition') && old('condition') == 'used') selected @endif>{{ __('product.used') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="club_point" id="club_point"
                                                           ...
                                                           min="0" value="{{old('club_point')?old('club_point'):0}}">
                                                    <span class="text-danger"
                                                                    ...
                                                                    <select name="choice_options_{{ $attribute->id }}[]"
                                                                        ...
                                                                        @foreach ($attribute->values as $key => $value)
                                                                            <option value="{{$value->id}}"
                                                                                    @if(in_array($value->id, old('choice_options_'.$attribute->id))) selected @endif> {{ $value->color ? $value->color->name : $value->value }} </option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-lg-12  weight_height_div">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for="breadth"> {{ __('product.breadth')}}
                                                            [{{__('product.cm')}}]</label>
                                        ...
                                        <div class="col-lg-12 digital_file_upload_div">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="pdf_place">{{__('product.program_file_upload') }}</label>
                                    ...
                                    <div class="row">
                                        ...
                                        @if(!isModuleActive('MultiVendor'))
                                            <div class="col-lg-12" id="stock_manage_div">
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <select class="primary_select mb-25" name="stock_manage"
                                                            id="stock_manage">
                                                        <option value="1"
                                                                @if(old('stock_manage') & old('stock_manage') == '1') selected @endif>{{ __('common.yes') }}</option>
                                                        <option value="0"
                                                                @if(old('stock_manage') & old('stock_manage') == '0') selected @endif>{{ __('common.no') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 d-none" id="single_stock_div">
                                                <div class="primary_input mb-15">
                                                    <label class="primary_input_label"
                                                           for="single_stock"> {{__('product.product_stock') }}</label>
                                                    <input class="primary_input_field" name="single_stock"
                                                           id="single_stock" type="number" min="0" step="0"
                                        ...
                                        <div class="col-lg-6 selling_price_div">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field selling_price" name="selling_price"
                                                       ...
                                                       min="1" step="{{step_decimal()}}"
                                                       value="{{old('selling_price')?old('selling_price'):''}}">
                                                <span class="text-danger"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select class="primary_select mb-25" name="discount_type"
                                                        id="discount_type">
                                                    <option value="1"
                                                            @if(old('discount_type') && old('discount_type') == 1) selected @endif>{{ __('common.amount') }}</option>
                                                    <option value="0"
                                                            @if(old('discount_type') && old('discount_type') == 0) selected @endif>{{ __('common.percentage') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <select class="primary_select mb-25" name="tax_id" id="tax_id">
                                                        ...
                                                        @foreach($gst_lists as $gst)
                                                            <option value="{{$gst->id}}"
                                                                    @if(old('tax_id') && old('tax_id') == $gst->id) selected @endif>{{ $gst->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        @else
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label"
                                                           for="tax_type">{{ __('gst.GST_group')}}</label>
                                                    <select class="primary_select mb-25" name="gst_group" id="tax_type">
                                                        <option value="" selected
                                                                disabled>{{__('common.select_one')}}</option>
                                                        @foreach($gst_groups as $group)
                                                            <option value="{{$group->id}}"
                                                                    @if(old('gst_group') && old('gst_group') == $group->id) selected @endif>{{ $group->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                                ...
                                                                <tr class="whole_sale_price_list">
                                                                    <td class="pl-0 pb-0 border-0">
                                                                        <input type="text"
                                                                               ...
                                                                               placeholder="{{__('wholesale.Min QTY')}}"
                                                                               name="wholesale_min_qty_0[]">
                                                                    </td>
                                                                    <td class="pl-0 pb-0 border-0">
                                                                        <input type="text"
                                                                               class="form-control primary_input_field"
                                                                               placeholder="{{__('wholesale.Max QTY')}}"
                                                                               name="wholesale_max_qty_0[]">
                                                                    </td>
                                                                    <td class="pl-0 pb-0 border-0">
                                                                        <input type="text"
                                                                               class="form-control primary_input_field"
                                                                               placeholder="{{__('wholesale.Price per piece')}}"
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="primary_input mb-15">
                                                                    <textarea class="summernote"
                                                                              name="description[{{$language->code}}]"> {{old('description.'.$language->code)}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="main-title d-flex">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="primary_input mb-15">
                                                                    <textarea class="summernote2" id="specification"
                                                                              name="specification[{{$language->code}}]"> {{old('specification.'.$language->code)}}</textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <div class="primary_file_uploader" data-toggle="amazuploader"
                                                        ...
                                                        <input class="primary-input file_amount" type="text"
                                                               id="meta_image_file"
                                                               placeholder="{{__('common.browse_image_file')}}"
                                                               readonly="">
                                                        <button class="" type="button">
                                                            <label class="primary-btn small fix-gr-bg"
                                ...
                                <div class="white_box pt-0 box_shadow_white p-15">
                                                ...
                                                <div class="primary_file_uploader" data-toggle="amazuploader"
                                                    ...
                                                    <button class="" type="button">
                                                        ...
                                                        <input type="hidden" class="selected_files image_selected_files"
                                                               value="{{old('images')?implode(',',old('images')):''}}">
                                                    </button>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="video_provider">{{ __('product.video_provider')}}</label>
                                                <select class="primary_select mb-25" name="video_provider"
                                                        id="video_provider">
                                                    <option value="youtube"
                                                            @if(!old('video_provider') || old('video_provider') == 'youtube') selected @endif>{{ __('product.youtube') }}</option>
                                                    <option value="daily_motion"
                                                            @if(old('video_provider') && old('video_provider') == 'daily_motion') selected @endif>{{ __('product.daily_motion') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    <li>
                                                        <label data-id="bg_option"
                                                            ...
                                                            <input name="status" id="status_active" value="1"
                                                                   @if(old('status') == null || old('status') == 1) checked
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                            ...
                                                            <input name="status" value="0" id="status_inactive"
                                                                   @if(old('status') != null && old('status') == 0) checked
                                                    ...
                                                    <li>
                                                        <label data-id="status_draft"
                                                               class="primary_checkbox d-flex mr-12">
                                                            <input name="status" value="3" id="status_draft"
                                                                   @if(old('status') != null && old('status') == 3) checked
                                                                   @endif class="de_active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <p>{{ __('common.draft') }}</p>
                                                    ...
                                                    <li>
                                                        <label data-id="bg_option"
                                                            ...
                                                            <input name="display_in_details" id="status_active"
                                                                   value="1"
                                                                   @if(!old('display_in_details') || old('display_in_details') == 1) checked
                                                                   @endif class="active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                            ...
                                                            <input name="display_in_details" value="2"
                                                                   id="status_inactive" class="de_active" type="radio"
                                                                   @if(old('display_in_details') && old('display_in_details') == 2) checked @endif>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        ...
                                                        <li>
                                                            <label data-id="bg_option"
                                                                ...
                                                                <input name="auto_update_required"
                                                                       ...
                                                                       @if(old('auto_update_required') == null || old('auto_update_required') == 1) checked
                                                                       @endif class="active" type="radio">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <p>{{ __('common.on') }}</p>
                                                        ...
                                                        <li>
                                                            <label data-id="color_option"
                                                                ...
                                                                <input name="auto_update_required" value="0"
                                                                       ...
                                                                       @if(old('auto_update_required') != null && old('auto_update_required') == 0) checked @endif>
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <p>{{ __('common.off') }}</p>
                                                        </li>
                                                    ...
                                                    <select class="primary_select mb-25" name="gold_price_id"
                                                        ...
                                                        @foreach($gold_prices as $gold_price)
                                                            <option data-price="{{$gold_price->price}}"
                                                                    value="{{$gold_price->id}}"
                                                                    @if(old('gold_price_id') && old('gold_price_id') == $gold_price->id) selected @endif>{{$gold_price->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="making_charge"
                                                           ...
                                                           step="{{step_decimal()}}"
                                                           value="{{old('making_charge')?old('making_charge'):0}}">
                                                    <span class="text-danger"
                                                ...
                                                <th scope="col">
                                                    <label class="primary_checkbox d-flex">
                                                        <input name="related_product[]" id="related_product_{{$key}}"
                                                               @if(isset($product) && @$product->relatedProducts->where('related_sale_product_id',$item->id)->first()) checked
                                                               @endif value="{{$item->id}}" type="checkbox"
                                                               class="related_product_checked">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </th>
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach ($products as $key => $item)
                                            <tr>
                                                <th scope="col">
                                                    <label class="primary_checkbox d-flex">
                                                        <input name="up_sale[]" id="up_sale_{{$key}}"
                                                               @if(isset($product) && @$product->upSales->where('up_sale_product_id',$item->id)->first()) checked
                                                               @endif value="{{$item->id}}" type="checkbox"
                                                ...
                                                <th scope="col">
                                                    <label class="primary_checkbox d-flex">
                                                        <input name="cross_sale[]" id="cross_sale_{{$key}}"
                                                               @if(isset($product) &&  @$product->crossSales->where('cross_sale_product_id',$item->id)->first()) checked
                                                               @endif value="{{$item->id}}" type="checkbox"
                                                               class="crosssale_product_checked">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </th>
                                                <td>{{ $item->product_name }}</td>
                    ...
                    <div class="col-12 text-center">
                        ...
                        @if(isModuleActive('MultiVendor'))
                            <button class="primary_btn_2 mt-5 text-center saveBtn" data-value="save_publish"><i
                                        class="ti-check"></i>{{ __('common.save') }} & {{ __('common.publish') }}
                            </button>
                        @endif
