                    ...
                    <div class="row">
                        ...
                        <div class="white_box_50px box_shadow_white mb-20">
                            ...
                            <div class="row">
                                        ...
                                        @foreach ($LanguageList as $key => $language)
                                            <li class="nav-item">
                                                <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                                                   href="#aelement{{$language->code}}" role="tab" data-toggle="tab"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <input class="primary_input_field"
                                                               name="name[{{$language->code}}]" id="name"
                                ...
                                <div class="col-lg-12">
                                    <strong>{{__("product.attribute_value")}}</strong> <span
                                                ...
                                                <table class="table create_attribute_table">
                                                    ...
                                                    <tr class="variant_row_lists">
                                                        <td class="pl-0 pb-0 border-0">
                                                            <input class="placeholder_input" name="variant_values[]"
