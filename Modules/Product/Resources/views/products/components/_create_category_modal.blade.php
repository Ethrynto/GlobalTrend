                                    ...
                                    <div role="tabpanel"
                                        ...
                                        <div class="primary_input mb-25">
                                            ...
                                            <input class="primary_input_field name" type="text"
                                                   id="category_name{{auth()->user()->lang_code == $language->code?$language->code:''}}"
                            ...
                            <div class="col-lg-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input class="primary_input_field commission_rate" type="number" min="0"
                                           step="{{step_decimal()}}"
                                           value="0" id="category_commission_rate" name="commission_rate"
                                           autocomplete="off"
                            ...
                            <div class="primary_input mb-25">
                                ...
                                <select class="mb-25" name="parent_id" id="parent_id">
                                    @if(isset($first_category) && $first_category != null)
                                        <option value="{{$first_category->id}}"
                                                selected>{{$first_category->name}}</option>
                                    @endif
                                </select>
