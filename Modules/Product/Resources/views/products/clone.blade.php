                                ...
                                <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                    <div class="row">
                                                    ...
                                                    <li>
                                                        <label data-id="bg_option"
                                                            ...
                                                            <input name="product_type" id="single_prod" value="1"
                                                                   {{$product->product_type == 2?'disabled':''}} {{$product->product_type == 1?'checked':''}}
                                                    ...
                                                    <li>
                                                        <label data-id="color_option"
                                                            ...
                                                            <input name="product_type" value="2" id="variant_prod"
                                                                   {{$product->product_type == 2?'disabled':''}} {{$product->product_type == 2?'checked':''}}
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for="model_number"> {{__("common.model_number")}}</label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for=""> {{__("product.minimum_order_qty")}} <span
                                                            class="text-danger">*</span></label>
                                                <input class="primary_input_field" name="minimum_order_qty"
                                                       id="minimum_order_qty" value="{{ $product->minimum_order_qty }}"
                                                       type="number" min="1" step="0" required="1">
                                                <span class="text-danger"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for=""> {{__("product.max_order_qty")}}</label>
                                            ...
                                            <div class="primary_input mb-25">
                                                ...
                                                <select name="choice_attributes[]" id="choice_attributes"
                                                    ...
                                                    <option value="" selected
                                                            disabled>{{__('product.select_attribute')}}</option>
                                                ...
                                                @foreach ($product->variations->unique("attribute_id") as $key => $choice_option)
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="primary_input mb-25"><input
                                                                        class="primary_input_field" width="40%"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 weight_height_div">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for=""> {{ __('product.weight')}} [{{__('product.gm')}}
                                                            ]</label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label"
                                                               for=""> {{ __('product.length')}} [{{__('product.cm')}}
                                                            ]</label>
                                                        <input value="{{@$product->skus->first()->length}}"
                                            ...
                                            <div class="primary_input mb-25">
                                                ...
                                                <div class="primary_file_uploader">
                                                    <input class="primary-input" type="text" id="pdf_place"
                                                           placeholder="{{__('product.upload_file')}}"
                                                           readonly="">
                                        ...
                                        <div class="col-lg-6 selling_price_div">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for=""> {{__("product.selling_price")}} <span
                                                            class="text-danger">*</span></label>
                                                <input class="primary_input_field selling_price" name="selling_price"
                                                       id="selling_price" placeholder="{{__("product.selling_price")}}"
                                                       type="number" min="1" step="{{step_decimal()}}"
                                                                ...
                                                                <tr class="whole_sale_price_list">
                                                                    ...
                                                                    <td class="pl-0 pb-0 pr-0 border-0">
                                                                        <div class="add_items_button pt-10">
                                                                            <button type="button"
                                                                                    class="primary-btn radius_30px add_single_whole_sale_price  fix-gr-bg">
                                                                                <i class="ti-plus"></i>
                                                                            </button>
                                                                        </div>
                                                                    </td>
                                ...
                                <div class="white_box pt-0 box_shadow_white p-15">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label"
                                                       for=""> {{__("product.video_link")}}</label>
