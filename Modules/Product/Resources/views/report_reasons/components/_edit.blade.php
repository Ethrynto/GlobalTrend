...
@endphp
<form method="POST" action="{{ route('product.report.update',$reason->id) }}" accept-charset="UTF-8"
      class="form-horizontal" enctype="multipart/form-data" id="add_category_form">
    <div class="white-box">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <input class="primary_input_field name" type="text" id="name" value="{{ $reason->name }}"
                            ...
                            <li>
                                <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="status" id="status_active" value="1"
                                           {{ $reason->status == 1 ? 'checked':'' }}  class="active" type="radio">
                            ...
                            <li>
                                <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="status" value="0" id="status_inactive"
                                           {{ $reason->status == 0 ? 'checked':'' }} class="de_active" type="radio">
                                    <span class="checkmark"></span>
                                </label>
                                <p>Inactive</p>
                            </li>
