...
@endphp
<form method="POST" action="{{ route('product.report.store') }}" accept-charset="UTF-8" class="form-horizontal"
      enctype="multipart/form-data" id="add_category_form">
    <div class="white-box">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <input class="primary_input_field name" type="text" id="name" name="name" autocomplete="off"
