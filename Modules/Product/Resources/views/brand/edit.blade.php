                            ...
                            <div class="row">
                                        ...
                                        @foreach ($LanguageList as $key => $language)
                                            <li class="nav-item">
                                                <a class="nav-link default_lang anchore_color @if (auth()->user()->lang_code == $language->code) active @endif"
                                                   data-id="{{$language->code}}" href="#element{{$language->code}}"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <input class="primary_input_field"
                                                               ...
                                                               value="{{isset($brand)?$brand->getTranslation('name',$language->code):old('name.'.$language->code)}}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <textarea class="summernote"
                                                                  name="description[{{$language->code}}]"> {{isset($brand)?$brand->getTranslation('description',$language->code):old('description.'.$language->code)}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                <div class="col-lg-12">
                                    <div class="tab-content">
                                        @foreach ($LanguageList as $key => $language)
                                            <div role="tabpanel"
                                                 class="tab-pane pelement fade @if (auth()->user()->lang_code == $language->code) show active @endif"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <input class="primary_input_field"
                                                               ...
                                                               value="{{isset($brand)?$brand->getTranslation('meta_title',$language->code):old('meta_title.'.$language->code)}}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <textarea
                                                                ...
                                                                spellcheck="false"> {{isset($brand)?$brand->getTranslation('meta_description',$language->code):old('meta_description.'.$language->code)}}</textarea>
                    ...
                    <div class="col-lg-4">
                        <div class="white_box_50px box_shadow_white">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-25">
                                        ...
                                        <select class="primary_select mb-25" name="status" id="status">
                                            <option value="1"
                                                    @if ($brand->status == 1) selected @endif>{{ __('common.publish') }}</option>
                                            <option value="0"
                                                    @if ($brand->status == 0) selected @endif>{{ __('common.pending') }}</option>
                                        </select>
                                        @error('status')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="col-lg-7">
                                    <div class="main-title d-flex">
                                        <h3 class="mb-2 mr-30">{{ __('common.logo') }} ({{getNumberTranslate(150)}}
                                            X {{getNumberTranslate(150)}}){{__('common.px')}}</h3>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="primary_input mb-25">
                                        <div class="primary_file_uploader" data-toggle="amazuploader"
                                             data-multiple="false" data-type="image" data-name="brand_image">
                                            <input class="primary-input file_amount" type="text" id="image"
                                                   placeholder="{{__('common.browse_image_file')}}" readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="image">{{__("blog.image")}} </label>
                                                <input type="hidden" class="selected_files"
                                                       value="{{@$brand->brand_image_media->media_id}}">
                                            </button>
                                        </div>
                                        <div class="product_image_all_div">
                                            @if(@$brand->brand_image_media->media_id)
                                                <input type="hidden" name="brand_image" class="product_images_hidden"
                                                       value="{{@$brand->brand_image_media->media_id}}">
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-30">
                                        <label class="switch_toggle" for="active_checkbox1">
                                            <input type="checkbox" id="active_checkbox1" name="featured"
                                                   @if ($brand->featured == 1) checked @endif>
