                            ...
                            <div class="col-xl-12">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="name[{{$language->code}}]" class="primary_input_field name"
                                           ...
                                           value="{{isset($attribute)?$attribute->getTranslation('name',$language->code):old('name.'.$language->code)}}">
                            ...
                            <div class="col-xl-12">
                                <div class="primary_input mb-25">
                                    ...
                                    <textarea class="primary_textarea height_112 description"
                                              ...
                                              spellcheck="false">{{isset($attribute)?$attribute->getTranslation('description',$language->code):old('description.'.$language->code)}}</textarea>
                    ...
                    <ul id="theme_nav" class="permission_list sms_list ">
                        <li>
                            <label data-id="bg_option"
                                ...
                                <input name="status" value="1" class="active"
                                       {{$attribute->status == 1?'checked':''}} type="radio">
                            ...
                            <table class="table">
                                            ...
                                            @if ($key === 0)
                                                <tr class="variant_edit_row_lists">
                                                    <td class="pl-0 pb-0 border-0 w-auto">
                                                        <input type='text' class='basic placeholder_input'
                                                               name="edit_variant_values[]" id='basic'
                                                               value='{{$items->value}}'/>
                                                        <input type="hidden" name="color_with_id[]"
                                                               value="{{$items->value}}-{{$items->id}}"/>
                                                    </td>
                                                    <td class="pl-0 pb-0 border-0">
                                                        <input type='text' class='placeholder_input'
                                                               placeholder='{{__('product.color_name')}}'
                                                               name="edit_variant_c_name[]"
                                                               value='{{$items->color->name}}'/>
                                                    </td>
                                                    <td class="pl-0 pb-0 pr-0 border-0">
                                                        <div class="add_items_button pt-10">
                                                            <button type="button"
                                                                    class="primary-btn primary-circle add_color_variant_edit_row  fix-gr-bg">
                                                                <i class="ti-plus"></i>
                                                            </button>
                                                        </div>
                                                    </td>
                                ...
                                @else
                                    @if(count($attribute->values) > 0)
                                        @foreach($attribute->values as $key => $items)
                                            @if ($key == 0)
                                                <tr class="variant_edit_row_lists">
                                                    <td class="pl-0 pb-0 border-0">
                                                        <input class="placeholder_input" value="{{$items->value}}"
                                                               placeholder="-" name="edit_variant_values[]" type="text">
                                                        <input type="hidden" class="d-none" name="value_id[]"
                                                               value="{{$items->id}}">
                                                        <input type="hidden" class="d-none" name="value_with_id[]"
                                                               value="{{$items->value}}-{{$items->id}}">
                                                    </td>
                                                    <td class="pl-0 pb-0 pr-0 border-0">
                                                        <div class="add_items_button pt-10">
                                                            <button type="button"
                                                                    class="primary-btn primary-circle add_single_variant_edit_row  fix-gr-bg">
                                                                <i class="ti-plus"></i>
                                                            </button>
                                                        </div>
                                                    </td>
                                    ...
                                    @else
                                        <tr class="variant_edit_row_lists">
                                            <td class="pl-0 pb-0 border-0">
                                                <input class="placeholder_input" name="edit_variant_values[]"
