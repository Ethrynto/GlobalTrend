                        ...
                        <div role="tabpanel"
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-15">
                                    ...
                                    <input class="primary_input_field" name="name[{{$language->code}}]" id="name"
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-15">
                                    ...
                                    <textarea class="primary_textarea height_112"
                                              ...
                                              spellcheck="false">{{old('description.'.$language->code)}}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
                            ...
                            <table class="table create_table">
                                ...
                                <tr class="variant_row_lists">
                                    <td class="pl-0 pb-0 border-0">
                                        <input class="placeholder_input" id="variant_values" name="variant_values[]"
