            ...
            $(document).ready(function() {
                $(document).on('change', 'input[type=radio][name=payment_method]', function(){
                    ...
                    if(method === 'Cash On Delivery'){
                        ...
                        $('#btn_div').html(`111<a href="javascript:void(0)" id="payment_btn_trigger" data-type="CashOnDelivery" data-url="`+url+`" class="amaz_primary_btn style2  min_200 text-center text-uppercase">{{__("hr.order_now")}}</a>`);
                    ...
                    }else if(method == 'AmeriaBank'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="AmeriaBank" class="amaz_primary_btn style2  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
...
<?php } ?>
    <script>
$(".payment_method[value=6]").parent().find(".label_name").html('Idram');
        $(document).on('change','input[name="payment_method"]',function(){
	document.cookie="paysys="+$(this).val()+"; path=/";
            generateTabbyFee();
