...
class Order extends Model
{
    ...
    public function guest_shipping_address(){
        return $this->hasOne(GuestAddressDetail::class,'order_id', 'id');
    }
    public function guest_billing_address(){
        return $this->hasOne(GuestAddressDetail::class,'order_id', 'id');
    }
    ...
    public function getGatewayNameAttribute()
    {
        switch ($this->method->slug) {
            ...
            case 'ccavenue':
                ...
                break;
            case "ameriabank":
                return __("payment_gatways.ameriabank");
                break;
            case 'idram':
                return __("payment_gatways.idram");
                break;
